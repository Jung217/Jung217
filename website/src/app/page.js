      ...
      <main className="container">
        ...
        <section id="contact" className="section">
          ...
          <div className="contact-info" style={{ maxWidth: '600px' }}>
            ...
            <p><strong>Location:</strong>&nbsp;EE610, No. 43, Sec. 4, Keelung Rd., Da&apos;an Dist., Taipei City 106335, Taiwan (R.O.C.)</p>
            <p><strong>Phone:</strong>&nbsp;+886 909160217 / +86 15859212926</p>
            <p><strong>Email:</strong>&nbsp;cjchien17@gmail.com</p>
            {/* 點擊按鈕直接開啟郵件客戶端 */}
            <a className="email-btn-wrapper" href="mailto:cjchien17@gmail.com">
              <button className="button" type="button">
                ...
                <div className="state state--default">
                  ...
                  <p>
                    <span style={{ '--i': 0 }}>S</span><span style={{ '--i': 1 }}>e</span><span style={{ '--i': 2 }}>n</span><span style={{ '--i': 3 }}>d</span><span style={{ '--i': 4 }}>M</span><span style={{ '--i': 5 }}>e</span><span style={{ '--i': 6 }}>s</span><span style={{ '--i': 7 }}>s</span><span style={{ '--i': 8 }}>a</span><span style={{ '--i': 9 }}>g</span><span style={{ '--i': 10 }}>e</span>
                  </p>
                </div>
